...
const char *MimeType::getType(const char *extension) {
...
const char *MimeType::getExtension(const char *type, int skip) {
...
int MimeType::strcmpi(const char *s1, const char *s2) {
    int i;
...
MimeType::entry MimeType::types[347] = {
    {"*3gpp", "audio/3gpp"},
    {"*jpm", "video/jpm"},
    {"*mp3", "audio/mp3"},
    {"*rtf", "text/rtf"},
